export default function ProjectInfo() {
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
      <h2 className="text-3xl font-bold text-slate-800 mb-6 border-b pb-4">Acerca del Proyecto</h2>
      
      <div className="space-y-6 text-slate-600">
        <section>
          <h3 className="text-xl font-semibold text-blue-800 mb-2">Objetivo Clínico</h3>
          <p>Esta herramienta predictiva fue desarrollada como parte de un trabajo de tesis para estimar el riesgo de padecer enfermedades cardiovasculares en pacientes. Utiliza variables antropométricas, demográficas y clínicas.</p>
        </section>
